    ...
    <body>
        <header>
            <nav>
                <!-- TO DO:logo画像が入る -->
                <a href="" id="logoBlock">
                    <img src="{{ asset('img/yana_logo.JPG') }}" alt="" id="headerLogo" width="125" height="52">
                </a>
                <ul>
                    <!-- お知らせ -->
                    <li>
        ...
        <footer>
            <div id="footerMain">
                ...
                <nav>
                    <ul>
                        <li><a href=""><span>お問い合わせ</apan></a></li>
                        <li><a href=""><span>会社概要</apan></a></li>
                        <li><a href=""><span>目指す場所</apan></a></li>
                        <li><a href=""><span>おしらせ</apan></a></li>
                    </ul>
                </nav>
            </div>
        </footer>
